...
!(function () {
  ...
  function Ft(t, e) {
    ...
    return (
      n.set(t, e),
      r ? H(e, a) && pt(n, "set", t, e) : pt(n, "add", t, e),
      this
    );
  }
  function Mt(t) {
  ...
  function $t(t, e) {
    return function (n, i) {
      ...
      return (
        !t && ut(a, 0, it),
        r.forEach((t, e) => n.call(i, c(t), c(e), o))
      );
    };
  }
  function Pt(t, e, n) {
  ...
  function Zn(t) {
    ...
    return (
      c
        ...
        : o.length || n || i
          ? ((s = {}),
            o.length && o.forEach((t) => Gn(s, t, a, !0)),
            Gn(s, e, a))
          : (s = e),
      O(e) && r.set(e, s),
      s
    ...
    return (function (t, e) {
      ...
      const {
        ...
        Z = (t, e, i, o, r = null) => {
          ...
          if (2 !== o && 1 & u && s)
            if (0 === o)
              (s.beforeEnter(a), n(a, e, i), bi(() => s.enter(a), r));
            else {
      ...
      const i = e.getBoundingClientRect(),
        ...
        l = ((t, e, n, i) => {
          ...
          return (
            ...
            (o.style.transition = `transform ${i.duration / 1e3}s ${i.easing}, opacity ${i.duration / 1e3}s ${i.easing}`),
            o
          );
        })(r, a, c, n);
      let u = "",
      ...
      actions: {
        ...
        changeMode(t) {
          ...
          const e = this.temperature,
            n = (t, e) =>
              `建议将空调的制${"clod" === t ? "冷" : "热"}温度调至 ${e} 度以${"clod" === t ? "上" : "下"}，为节能减排贡献一份力量！`;
          "clod" === t && e < 26
            ? gr.show({
                text: n("clod", 26),
        ...
        setup: (t) => (e, n) => {
          ...
          return (function (t, e) {
            ...
            Ri(
              ...
              {
                class: c(
                  `anzhiyu-button ${t.round ? "anzhiyu-button-round" : ""} anzhiyu-button-${t.type}`,
                ),
              },
  ...
  const Jr = Go(qr, [
    ...
    Yr = "https://zako.net.cn",
    Xr = "zakonet",
    Qr = "https://zatursure.com",
    ta = { class: "copyright-box" },
    ea = { class: "copyright-p-1" },
    na = ["href"],
    ia = ((t) => (We("data-v-13c379f0"), (t = t()), qe(), t))(() =>
      Li(
        "a",
        {
        ...
        [Li("div", { class: "copyright-p-1-1-icon" })],
        -1,
      ),
    ),
    oa = ["href"],
        ...
        setup: (t) => (t, e) => (
          ...
          Ri("div", ta, [
            Li("div", ea, [
              ...
              Li(
                "a",
                { href: Qr, target: "_blank", rel: "noreferrer" },
                "渣土の小风扇",
                8,
                na,
              ),
              ...
              Li(
                "a",
                { href: Yr, target: "_blank", rel: "noreferrer" },
                "ZakoDevTeam @" + u(Xr),
                9,
                oa,
              ),
            ]),
            Li("p", null, "2025 - " + u(new Date().getFullYear()), 1),
          ])
        ),
      }),
    ...
    ca = ((...t) => {
      ...
      Go(
        fn({
          ...
          setup: (t) => (t, e) => (
            Ei(),
            Ri("main", aa, [Vi(Qo), Vi(Jr), Vi($r), Vi(Wr), Vi(ra)])
          ),
        }),
